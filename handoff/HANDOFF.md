...
>
> 최종 갱신 **2026-09-01** · 기준 커밋 **HEAD ≥ `342bc97`** · 브랜치 `design/first-vertical-slice`
...
| 항목 | 값 |
|---|---|
| 테스트 | **365 passed**, skip/xfail 0 (241 → 312 → 327 → 333 → 347 → 348 → 365) |
| I-1 순증 | 새 테스트 **18건** − 폐기 **1건** = +17. 폐기 근거는 `TASKS.md` I-1 (**되살리지 말 것**) |
...
| 3 | 게이트 | **365 passed** · ruff·format(27파일)·ty clean · `tests/**` 베이스라인 **6 errors·4 files** · 프론트 `tsc`·`eslint` exit 0 |
