...
| 2 | 다음 한 걸음 | **`TASK-61.5`** — 한국어에서 코치가 침묵하는 원인 후보 ②를 가르는 관측 하나. 회차 §4 가 그 방법을 적어 뒀음(표지 없는 한국어 학습 발화 한 팔 · 픽스처를 새로 만들어야 함) |
...
| 태스크 | 왜 열려 있나 |
|---|---|
| `TASK-61.5` | 다음 한 걸음. 원인 후보 ②를 가르는 관측 하나가 남았고 방법이 회차 §4 에 있음 |
...
- **결정 101~105** — 정본은 `docs/ops/captain-instruction-register.md` 머리 근처임. 특히 **103**
