...
- [x] #3 결과에 따라 그 줄을 고칠지 정한다 — ⛔ 고치는 안은 카테고리 공용 기제를 깨지 않는 것이어야 한다
<!-- AC:END -->
...
방향 결정 2026-09-15 (세션 ohmyenglish-65) — AC#3 을 사용자 판단으로 닫았음. 정본은 결정 97 임. 정한 것: plan.py:320 을 고치지 않고 다음 수단을 기록 경로(TASK-116.3)로 둠. 기각된 것 둘 — 그 줄에서 키를 가림 · 계획과 후보 목록을 함께 다시 엶.
<!-- SECTION:NOTES:END -->
