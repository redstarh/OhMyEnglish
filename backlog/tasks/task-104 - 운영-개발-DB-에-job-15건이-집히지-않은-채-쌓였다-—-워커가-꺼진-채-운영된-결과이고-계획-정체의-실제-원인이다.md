...
2026-09-12 정정 — 최신 계획 행의 시각을 22:40 으로 적었는데 실제는 22:41:27(세션 24597f0f)임. 내가 그 값을 «마지막 재시도가 끝나기 전에» 읽었고, 그 재시도가 최신 행을 만들었음. 동료 세션(ohmyenglish-7f)이 22:41 을 세어 어긋남을 알렸고 다시 조회해 확인했음.

⛔ 교훈은 수치가 아님 — 「그 턴에 직접 돌린 출력만 적는다」로는 부족하고 «마지막 단계가 끝난 뒤에 다시 읽어야» 함. 여기서 마지막 단계는 24597f0f 의 2회차 재시도였음. 회차 기록 머리말에 그 교훈을 함께 남겼음.
