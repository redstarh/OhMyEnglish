...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 버려진 명령을 프레임으로 알리고 화면이 그것을 말한다 — 대상 명령 셋만
- [ ] #2 확인 대기 상태를 화면이 말한다 — end · start_additional
- [ ] #3 next_question 은 두 표면 어디에도 들어가지 않는 것을 단정으로 지킨다
- [ ] #4 게이트 여섯이 초록인 것을 직접 돌려 확인한다
- [ ] #5 실물 회차로 두 표면을 관측한다 — TASK-61.13 AC#3 과 TASK-61.15 AC#4 를 그 회차가 함께 닫는다
<!-- AC:END -->
