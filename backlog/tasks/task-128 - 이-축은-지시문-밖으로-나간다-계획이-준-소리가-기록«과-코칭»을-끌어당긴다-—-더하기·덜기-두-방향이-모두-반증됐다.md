...
- [x] #4 결정을 받은 뒤 판별 조건(pq13 + 오디오에 없는 소리를 심음)으로 재고 그 결과로 TASK-116 을 닫거나 남긴다
<!-- AC:END -->
...
닫음 2026-09-15 (세션 ohmyenglish-65) — AC#4 를 기존 회차로 닫았음.

결정 72 를 받은 뒤 판별 조건(pq13 + 오디오에 없는 소리 f_as_p)으로 두 번 다시 쟀음: TASK-128.3 ARM-B 가 전용 모드에서 3/3 되풀이(결정 72 의 의도한 효과가 나지 않았음) · TASK-129 가 일반 세션에서 3/3 되풀이. ⇒ 「지시문 밖으로 나간다」는 이 축의 결론이 유지되고 다음 수단이 기록 경로임이 실측으로 확정됐음(결정 82·97).

AC#4 의 「그 결과로 TASK-116 을 닫거나 남긴다」 — TASK-116 을 같은 턴에 닫았음. 근거는 어긋남이 사라진 것이 아니라 «오염 경로»가 막힌 것이고, 남은 구멍(문장 전체 인용)은 TASK-116.5 로 남겼음.
<!-- SECTION:NOTES:END -->
