...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 handoff/HANDOFF.md 가 120줄 이하다 — wc -l 출력을 근거로 적는다
- [x] #2 걷어낸 내용마다 정본 파일을 가리키는 한 줄이 남아 있다 (내용을 두 곳에 두지 않는다)
- [x] #3 다음 한 걸음 절과 인계 지표 4개 절은 보존한다 — 이 둘이 handoff 의 존재 이유다
- [x] #4 걷어낸 것과 그 정본을 커밋 메시지에 적는다 (다음 세션이 무엇이 어디로 갔는지 안다)
<!-- AC:END -->
