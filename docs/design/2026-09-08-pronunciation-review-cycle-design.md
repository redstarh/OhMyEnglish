...
3. **`2026-08-25-learning-coach-agent-design.md:168-177`(구현 공백 4)과 `:481`(§11 이월),
   `2026-09-04-learning-coach-slice2-plan.md:121`·`:2724-2728`(AS11)이 낡는다.** 넷 다 "발음은
   복습에 들어오지 않는다"를 전제한다. 구현 시 함께 정정할 목록이다(철회 사실과 근거를 남긴다).
